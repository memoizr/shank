package life.shank
 ...
 class ScopedProvider5<A, B, C, D, E, T>() : Provider<T, ScopedFactory.(A, B, C, D, E) -> T> {
    operator fun invoke(scope: Scope, a: A, b: B, c: C, d: D, e: E): T =
        get(scope, Params5(a, b, c, d, e)) { invokescoped(SimpleScopedFactory(scope), a, b, c, d, e) }
}
