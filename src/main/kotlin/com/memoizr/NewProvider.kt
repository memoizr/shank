...
class NewProvider<T : Any>(f: () -> T) : Provider<T>(f) {
...
class NewProvider1<A : Any, T : Any>(f: (A) -> T) : Provider<T>(f) {
...
class NewProvider2<A : Any, B : Any, T : Any>(f: (A, B) -> T) : Provider<T>(f) {
...
class NewProvider3<A : Any, B : Any, C : Any, T : Any>(f: (A, B, C) -> T) : Provider<T>(f) {
...
class NewProvider4<A : Any, B : Any, C : Any, D : Any, T : Any>(f: (A, B, C, D) -> T) : Provider<T>(f) {
...
class NewProvider5<A : Any, B : Any, C : Any, D : Any, E : Any, T : Any>(f: (A, B, C, D, E) -> T) : Provider<T>(f) {
