...
class ScopedProvider<T : Any>(factory: ScopedFactory.() -> T) : Provider<T>(factory) {
...
class ScopedProvider1<A : Any, T : Any>(factory: ScopedFactory.(A) -> T) : Provider<T>(factory) {
...
class ScopedProvider2<A : Any, B : Any, T : Any>(factory: ScopedFactory.(A, B) -> T) :
    Provider<T>(factory) {
...
class ScopedProvider3<A : Any, B : Any, C : Any, T : Any>(factory: ScopedFactory.(A, B, C) -> T) :
    Provider<T>(factory) {
...
class ScopedProvider4<A : Any, B : Any, C : Any, D : Any, T : Any>(factory: ScopedFactory.(A, B, C, D) -> T) :
    Provider<T>(factory) {
...
class ScopedProvider5<A : Any, B : Any, C : Any, D : Any, E : Any, T : Any>(factory: ScopedFactory.(A, B, C, D, E) -> T) :
    Provider<T>(factory) {
